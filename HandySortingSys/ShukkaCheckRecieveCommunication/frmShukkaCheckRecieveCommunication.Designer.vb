...
Partial Class frmShukkaCheckRecieveCommunication
  ...
  Protected Overloads Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmShukkaCheckRecieveCommunication))
    ...
    Me.LblBase1 = New T.R.ZCommonCtrl.LblBase()
        ...
        Me.BtnRecieveHandy1.TabIndex = 25
    ...
    Me.BtnEnd_L1.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageAboveText
        ...
        Me.LblBase1.Text = "ハンディ出荷検品データ受信"
        '
        'frmShukkaCheckRecieveCommunication
        '
        ...
        Me.Name = "frmShukkaCheckRecieveCommunication"
        Me.Text = "Form1"
