Public Class CmbMstTekiyouAndText

#Region "メンバ"
#Region "プライベート"
  ''' <summary>
  ''' 摘要コンボボックス＋名称表示 コントロール
  ''' コード入力用テキストボックス（TxtBaseを継承）と
  ''' 摘要コンボボックス（CmbMstBaseを継承）の
  ''' 複合コントロールです
  ''' </summary>
...
#Region "プライベート"
  ...
  ''' <param name="e"></param>
  Private Sub CmbMstTekiyouAndTextAndText_Load(sender As Object, e As EventArgs) Handles MyBase.Load
