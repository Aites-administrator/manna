...
Public Class TxtCustomerType2Code
  Inherits TxtNumericBase

  ' 得意先分類コード２入力用テキストボックス
...
#Region "コンストラクタ"
  ...
  Public Sub New()
    ...
    MyBase.New(3)
    ' フォーカス時、表示メッセージ設定
    MyBase.SetMsgLabelText("得意先分類コード２を入力してください。")
  End Sub
#End Region
...
#Region "イベントプロシージャー"
  Private Sub TxtDateBase_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
    ...
    With Me
      ...
      .Text = StringToInt(.Text).ToString(CUSTOMER_TYPE02_ZERO_PADDING)
