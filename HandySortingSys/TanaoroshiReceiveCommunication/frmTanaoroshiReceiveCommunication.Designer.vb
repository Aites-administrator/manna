...
Partial Class frmTanaoroshiReceiveCommunication
  ...
  Protected Overloads Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmTanaoroshiReceiveCommunication))
    ...
    Me.LblBase1 = New T.R.ZCommonCtrl.LblBase()
        ...
        Me.LblBase1.TabIndex = 15
        Me.LblBase1.Text = "ハンディ棚卸データ受信"
        '
        'frmTanaoroshiReceiveCommunication
        '
        ...
        Me.Name = "frmTanaoroshiReceiveCommunication"
        Me.Text = "Form1"
